...
class Product {
  ...
  static List<Map<String, dynamic>> allproduct = [
    {'id': 1, 'name': "Soap", 'price': 999},
    {'id': 2, 'name': "Toothpaste", 'price': 99},
    {'id': 3, 'name': "Chilly Powder", 'price': 29},
    {'id': 4, 'name': "Tomato", 'price': 59},
    {'id': 5, 'name': "cabbage", 'price': 35},
    {'id': 6, 'name': "Graps", 'price': 59},
    {'id': 7, 'name': "Mango Pulp", 'price': 299},
    {'id': 8, 'name': "Pumpkin", 'price': 22},
    {'id': 9, 'name': "Ice-cream", 'price': 39},
    {'id': 10, 'name': "Apple", 'price': 78},
  ];
}
